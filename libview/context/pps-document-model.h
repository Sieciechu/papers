 ...
 * @PPS_ANNOTATION_EDITING_STATE_NONE: No editing
 * @PPS_ANNOTATION_EDITING_STATE_INK: Ink editing
 * @PPS_ANNOTATION_EDITING_STATE_TEXT: Text editing
 * @PPS_ANNOTATION_EDITING_STATE_STAMP: Stamp editing
 * @PPS_ANNOTATION_EDITING_STATE_INSERT_TEXT: Insert text editing
 * @PPS_ANNOTATION_EDITING_STATE_SHAPE: Shape editing
 * @PPS_ANNOTATION_EDITING_STATE_PIXELIZE: Pixelize editing
 */
typedef enum {
	...
	PPS_ANNOTATION_EDITING_STATE_SHAPE = 1 << 4,
	PPS_ANNOTATION_EDITING_STATE_PIXELIZE = 1 << 5
} PpsAnnotationEditingState;
